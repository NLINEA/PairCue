<p align="center">
  <img src="src/paircue/setup/favicon.svg" width="88" alt="PairCue 標誌">
</p>

<h1 align="center">PairCue</h1>

<p align="center"><strong>你嘅片庫，兩種語言。</strong></p>
...
![PairCue 將同一幕變成對齊嘅雙語字幕](docs/images/paircue-outcome.png)

PairCue 會重用、搜尋或生成字幕，需要時先翻譯，再按時間對齊兩種語言，最後喺影片旁邊
建立一份普通嘅 `Movie.mul.srt`。

唔使轉播放器、唔使裝瀏覽器插件、唔使開 PairCue 帳戶，亦冇自動數據追蹤。

> PairCue 仍然係 Beta。第一次請用安全示範、兩份 SRT，或者一條影片副本。
...
語言。原有兩份檔案預設逐 byte 保持不變；如果時間配對信心太低，PairCue 會停止，唔會
夾硬輸出或者覆蓋舊字幕。
...
- PairCue 冇帳戶、冇 analytics、冇自動 telemetry。
