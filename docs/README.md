...
- [Troubleshooting](TROUBLESHOOTING.md) — app warnings, missing results, FFmpeg, providers, and
  player visibility.
- [Cantonese introduction](../README.zh-HK.md) — a short non-technical starting point.

## I want to set up a library

- [Configuration](CONFIGURATION.md) — platforms, languages, search, translation, transcription,
  alignment, and webhooks.
- [Docker and NAS](DOCKER.md) — always-on installation.
- [Download Station](DOWNLOAD_STATION.md) — optional isolated download workflow.

## I want to understand or contribute

- [Architecture](../ARCHITECTURE.md) — processing flow and trust boundaries.
- [Security](../SECURITY.md) — data flow and private vulnerability reporting.
- [Roadmap](../ROADMAP.md) — current product priorities.
